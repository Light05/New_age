...
<?  function menuNewAge () {?>
<li></li>
					<li><a href="pages/new_age/we/">Мы</a></li>
					<li><a href="pages/new_age/portfolio/">Портфолио</a></li>
					<li><a href="pages/new_age/our_projects/">Наши проекты</a></li>
					<li><a href="pages/new_age/news/">Новости</a></li>
					<li><a href="pages/new_age/articles/">Статьи</a></li>
					<li class="end"><a href="pages/new_age/contacts/">Контакты</a></li>
<?	return;} ?>					
<?
/* function menuNewAge () {
	$menuNewAge = array (
